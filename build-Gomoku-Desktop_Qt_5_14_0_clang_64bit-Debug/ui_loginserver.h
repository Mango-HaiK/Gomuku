...
public:
    ...
    void setupUi(QWidget *LoginServer)
    {
        ...
        label_show_status = new QLabel(LoginServer);
        label_show_status->setObjectName(QString::fromUtf8("label_show_status"));
        label_show_status->setEnabled(true);
        label_show_status->setGeometry(QRect(110, 210, 131, 21));
    ...
    void retranslateUi(QWidget *LoginServer)
    {
        ...
        label_show_status->setText(QCoreApplication::translate("LoginServer", "\346\255\243\345\234\250\350\277\236\346\216\245\346\234\215\345\212\241\345\231\250...", nullptr));
    } // retranslateUi
